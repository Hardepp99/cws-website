...
export function EntityEditorModePanel({
  ...
  async function setLiveMode(mode: DisplayMode) {
    ...
    try {
      ...
      setPanelMsg(
        mode === "elementor"
          ? "Live site now uses the Elementor layout (classic content is still saved)."
          : "Live site now uses classic content (Elementor layout is still saved)."
      );
    } catch (e) {
  ...
  async function publishElementor() {
    setPublishBusy(true);
    setPanelErr("");
    try {
      ...
      setTab("elementor");
      setPanelMsg("Elementor layout published and set as the live version.");
    } catch (e) {
      setPanelErr(String(e));
    } finally {
  ...
  const liveLabel = displayMode === "elementor" ? "Elementor" : "Classic";
    ...
    <div className="entity-editor-mode">
      <div className="entity-editor-mode__live">
        ...
        <span className="entity-editor-mode__hint">
          Classic and Elementor content are stored separately — switching only changes what visitors see.
        </span>
      </div>
      ...
      <div className="entity-editor-mode__tabs" role="tablist">
        ...
        <button
          ...
          disabled={isNew}
          title={isNew ? "Save the page first to use Elementor" : undefined}
        >
      ...
      {tab === "classic" ? (
        <div className="entity-editor-mode__panel">
          <p className="entity-editor-mode__panel-desc">
            Edit title, HTML content, and SEO. This does not change your Elementor layout.
          </p>
        ...
        <div className="entity-editor-mode__panel entity-editor-mode__panel--elementor">
          {isNew ? (
            <p className="cms-notice">
              Save this page once, then you can open the Elementor builder. Classic HTML can be added anytime.
            </p>
          ) : (
            <>
              <p className="entity-editor-mode__panel-desc">
                Build the page visually in Elementor. Your classic HTML content stays in the Classic tab and is not
                overwritten.
              </p>
              <dl className="entity-editor-mode__stats">
                <div>
                  <dt>Elementor status</dt>
              ...
              <div className="entity-editor-mode__actions entity-editor-mode__actions--stack">
                ...
                <button
                  ...
                  onClick={() => publishElementor()}
                >
                  {publishBusy ? "Publishing…" : "Publish Elementor layout"}
                </button>
                <button
                  type="button"
                ...
                >
                  Use Elementor on live site
                </button>
              </div>
              <p className="entity-editor-mode__footnote">
                <strong>Publish Elementor layout</strong> saves the builder and switches the live site to Elementor.
